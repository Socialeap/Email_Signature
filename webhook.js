...
// It acts as a webhook to receive data from Jotform after a successful payment.

const sgMail = require('@sendgrid/mail');

// Set your SendGrid API Key. 
// IMPORTANT: Store this in your Netlify site's environment variables, not in the code.
...
exports.handler = async function(event, context) {
    ...
    try {
        ...
        // 5. Prepare and send the email to the customer
        const msg = {
            to: customerEmail,
            from: 'your-verified-sender@yourdomain.com', // Use a verified sender email in SendGrid
